...
export const userInfo: UserObject = {
    ...
    about: `
    <p>I am a passionate front-end developer and AI enthusiast  with a proficiency in modern front-end technoligies,including Html, Custom & Tailwind Css and Typescript, with hands-on experience in javascript library 'React' and it's framework 'Next.js'.</p>
